...
class InterfaceGrafica:
    ...
    def abrir_tela_menu_funcionario(self):
        # Criação da nova janela para o menu do funcionário
        ...
        # Implemente a lógica para exibir os elementos do menu do funcionário
        # e adicione widgets, como botões, campos de entrada, etc., conforme necessário.
    
        # Exemplo de botão para fechar a janela
